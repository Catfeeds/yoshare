 ...
 *
 *
 * @author     尤开利<573358951@qq.com>   2016-4-23 上午10:13
 * @copyright  Copyright (c) 2004-2016 Mainone Technologies Inc. (http://www.b2b.cn)
...
class JsModel extends Model{
	...
	private $appid = '';  //wxcc6ec6007df61024
    private $mch_id = '';
	private $key = '';
    private $AppSecret = '';
	 ...
	 */
 	public function unifiedOrder($out_trade_no,$total_fee,$ip,$openid,$body){
	  ...
	  $info['notify_url'] = 'http://demo20.mainone.b2b.cn/index.php/goods/Payment/notify';//支付通知
