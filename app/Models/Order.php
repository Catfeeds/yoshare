...
class Order extends BaseModule
{
    ...
    protected $fillable = ['site_id', 'order_num', 'member_id', 'name', 'address', 'phone', 'ship_id', 'pay_id', 'total_pay', 'total_price', 'ship_price', 'state', 'note', 'paid_at', 'shipped_at', 'finished_at'];
