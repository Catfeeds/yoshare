...
@section('content')
    ...
    <script>
        ...
        function titleFormatter(value, row, index) {
            return '<a href="/contents/' + row.content_id + '" target="_blank"  class="content_title" data-toggle="tooltip" data-placement="top" title="' + value + '">' + value + '</a>';
        }
