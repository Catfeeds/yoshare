...
@section('content')
                ...
                <div class="col-md-10">
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            @include('layouts.modal', ['id' => 'modal_create'])
                            ...
                            <table id="table"
                                   data-toggle="table"
                                   data-url="/categories/table/{{ $category_id }}"
                                ...
                                <tr>
                                    ...
                                    <th data-field="template" data-align="center" data-width="90">模板</th>
    ...
    <script>
        ...
        $.getJSON('/categories/tree', function (data) {
            $('#tree').treeview({
                ...
                onNodeSelected: function (event, data) {
                    location.href = '/categories?category_id=' + data.id;
                }
            });
        ...
        $(".create").click(function () {
            window.location.href = '/categories/create/' + '{{ $category_id }}';
        });
