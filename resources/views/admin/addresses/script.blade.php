<script>
    ...
    function titleFormatter(value, row, index) {
        return '<a href="/addresses/detail-' + row.id + '.html" target="_blank">' + row.title + '</a>' +
    ...
    function updateRow(field, row, old, $el) {
        $.ajax({
            url: '/admin/addresses/' + row.id + '/save',
            type: 'post',
    ...
    window.actionEvents = {
        ...
        'click .top': function (e, value, row, index) {
            $.ajax({
                url: '/admin/addresses/' + row.id + '/top',
                type: 'post',
        ...
        'click .tag': function (e, value, row, index) {
            $.ajax({
                url: '/admin/addresses/' + row.id + '/tag',
                type: 'post',
        ...
        'click .comment': function (e, value, row, index) {
            ...
            var url = '/admin/addresses/comments/' + row.id;
            $.ajax({
                url: url,
                type: "get",
                data: {'_token': '{{ csrf_token() }}'},
