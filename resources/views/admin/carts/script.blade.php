<script>
    ...
    function titleFormatter(value, row, index) {
        return '<a href="/carts/detail-' + row.id + '.html" target="_blank">' + row.title + '</a>' +
    ...
    window.actionEvents = {
        ...
        'click .comment': function (e, value, row, index) {
            ...
            var url = '/admin/carts/comments/' + row.id;
            $.ajax({
                url: url,
                type: "get",
                data: {'_token': '{{ csrf_token() }}'},
