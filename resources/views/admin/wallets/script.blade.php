<script>
    ...
    function titleFormatter(value, row, index) {
        return '<a href="/wallets/detail-' + row.id + '.html" target="_blank">' + row.title + '</a>' +
    ...
    window.actionEvents = {
        ...
        'click .comment': function (e, value, row, index) {
            ...
            var url = '/admin/wallets/comments/' + row.id;
            $.ajax({
                url: url,
                type: "get",
                data: {'_token': '{{ csrf_token() }}'},
