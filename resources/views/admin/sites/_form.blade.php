...
<div id="tabContents" class="tab-content">
    <div id="tabHome" class="tab-pane fade in active padding-t-15">
        ...
        <div class="form-group">
            {!! Form::label('directory', '目录:',['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
                {!! Form::text('directory', null, ['class' => 'form-control']) !!}
            </div>
            {!! Form::label('domain', '域名:', ['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
        ...
        <div class="form-group">
            {!! Form::label('default_theme', '默认主题:',['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
                {!! Form::select('default_theme',$themes, !isset($site->default_theme) ? '1':$site->default_theme ,['class' => 'form-control col-sm-2']) !!}
            </div>
            {!! Form::label('mobile_theme', '移动主题:',['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
    ...
    <div id="tabAndroid" class="tab-pane fade padding-t-15">
        <div class="form-group">
            {!! Form::label('jpush_app_key', '极光AppKey:',['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
                {!! Form::text('jpush_app_key', null, ['class' => 'form-control']) !!}
            </div>
            {!! Form::label('jpus_app_secret', '极光AppSecret:', ['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
                {!! Form::text('jpus_app_secret', null, ['class' => 'form-control']) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::label('wechat_app_id', '微信AppID:',['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
                {!! Form::text('wechat_app_id', null, ['class' => 'form-control']) !!}
            </div>
            {!! Form::label('wechat_secret', '微信Secret:', ['class' => 'control-label col-sm-2']) !!}
            <div class="col-sm-4">
