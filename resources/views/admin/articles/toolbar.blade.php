...
<div class="btn-group margin-bottom">
    ...
    <button class="btn btn-success btn-xs margin-r-5 state" value="{{ \App\Models\Article::STATE_PUBLISHED }}">发布</button>
    <button class="btn btn-warning btn-xs margin-r-5 state" value="{{ \App\Models\Article::STATE_CANCELED }}">撤回</button>
    <button class="btn btn-danger btn-xs margin-r-5" id="btn_delete" value="{{ \App\Models\Article::STATE_DELETED }}" onclick="remove()" data-toggle="modal" data-target="#modal">删除</button>
