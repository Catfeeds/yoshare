...
<div class="btn-group margin-bottom">
    ...
    <button class="btn btn-warning btn-xs margin-r-5 state" value="{{ \App\Models\Order::STATE_CANCELED }}">撤回</button>
...
<div class="btn-group margin-bottom pull-right">
    ...
    <button type="button" class="btn btn-default btn-xs margin-r-5 filter" data-active="btn-primary" value="{{ \App\Models\Order::STATE_NORMAL }}">未发布</button>
    <button type="button" class="btn btn-default btn-xs margin-r-5 filter" data-active="btn-success" value="{{ \App\Models\Order::STATE_PUBLISHED }}">已发布</button>
    <button type="button" class="btn btn-default btn-xs margin-r-5 filter" data-active="btn-warning" value="{{ \App\Models\Order::STATE_CANCELED }}">已撤回</button>
    <button type="button" class="btn btn-default btn-xs margin-r-5 filter" data-active="btn-danger" value="{{ \App\Models\Order::STATE_DELETED }}">已删除</button>
