<script>
    ...
    function titleFormatter(value, row, index) {
        return '<a href="/ships/detail-' + row.id + '.html" target="_blank">' + row.title + '</a>' +
    ...
    window.actionEvents = {
        ...
        'click .comment': function (e, value, row, index) {
            ...
            var url = '/admin/ships/comments/' + row.id;
            $.ajax({
                url: url,
                type: "get",
                data: {'_token': '{{ csrf_token() }}'},
