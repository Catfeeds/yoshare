...
@section('content')
    ...
    <script>
        ...
        $.getJSON('/models/tree', function (data) {
            $('#tree').treeview({
                data: data,
                searchResultColor: 'white',
                levels: 3,
                onNodeSelected: function (event, data) {
                    location.href = '/models?model_id=' + data.id;
                }
            });
        });
        ...
        $(".create").click(function () {
            window.location.href = '/models/create/' + '{{ $model_id }}';
        });
        ...
        window.actionEvents = {
            'click .edit': function (e, value, row, index) {
                window.location.href = '/models/' + row.id + '/edit';
            },
