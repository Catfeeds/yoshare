...
@section('content')
    ...
    <div class="content">
        ...
        <div class="tips">
            <h3>租期计算方式</h3>
            <p style="text-indent: 80px">按月收费，周期最多为37天，从您付费后开始计算，一般游戏会在三天左右到您手中，平台额外给出您四天左右时间归还光盘；请您及时确认收货，查看归还时间；</p>
            <p style="text-indent: 80px">如您超过此时间，我们将按超出时间的长短来收取逾期费用，超出1-30天收取该盘的每月单价，以此类推。</p>
        </div>
