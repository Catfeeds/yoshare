...
class PageController extends BaseController
{
    ...
    public function show(Domain $domain, $id)
    {
        ...
        return view($domain->theme->name . '.pages.detail', ['site' => $domain->site, 'page' => $page]);
    }
    ...
    public function lists(Domain $domain)
    {
        ...
        return view($domain->theme->name . '.pages.index', ['site' => $domain->site, 'module' => $this->module, 'pages' => $pages]);
    }
