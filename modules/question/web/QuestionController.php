...
class QuestionController extends BaseController
{
    ...
    public function show(Domain $domain, $id)
    {
        ...
        return view($domain->theme->name . '.questions.detail', ['site' => $domain->site, 'question' => $question]);
    }
    ...
    public function lists(Domain $domain)
    {
        ...
        return view($domain->theme->name . '.questions.index', ['site' => $domain->site, 'module' => $this->module, 'questions' => $questions]);
    }
