...
class ArticleController extends BaseController
{
    ...
    public function show(Domain $domain, $id)
    {
        ...
        return view($domain->theme->name . '.articles.detail', ['site' => $domain->site, 'article' => $article]);
    }
    ...
    public function lists(Domain $domain)
    {
        ...
        return view($domain->theme->name . '.articles.index', ['site' => $domain->site, 'module' => $this->module, 'articles' => $articles]);
    }
    ...
    public function category(Domain $domain, $category_id)
    {
        ...
        return view($domain->theme->name . '.articles.category', ['site' => $domain->site, 'category' => $category, 'articles' => $articles]);
    }
